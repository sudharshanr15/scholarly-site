...
<x-user_admin.Layout>
    <h1 class="mb-6 text-2xl font-semibold">Create Faculty</h1>
    <div class="bg-light-fg dark:bg-dark-fg p-6 rounded">
        <form action="{{ route('faculty.register') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <x-form.input id="mobile" name="mobile" placeholder="+91 9876543219" value="{{ old('mobile') }}"></x-form.input>
                <x-form.error name="mobile"></x-form.error>
            </div>
            <div class="mb-4">
